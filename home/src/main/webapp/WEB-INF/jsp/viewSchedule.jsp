...
<body>
    <nav class="navbar navbar-dark bg-dark">
        ...
        <a href="/Home"><button type="button float-right" style="margin-right: 20px;" class="btn btn-outline-light">Home</button></a>
      </nav>
      <br>
      <div class="container">
        <div class="row">
                ...
                <div class="card text-center shadow-lg">
                    ...
                    <div class="card-block">
                        ...
                        <form action="/RepSchedule" method="GET">
                        	<div class="controls">
                            <input type="date" class="date" id="startdate" name="startdate"><br><br>
